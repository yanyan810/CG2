...
//}
//
//void SrvManager::CreateSRVTexture2D(
//    uint32_t srvIndex,
...
//
//    dxCommon_->GetCommandList()->SetGraphicsRootDescriptorTable(RootParameterIndex, GetGPUDescriptionHandle(srvIndex));
//
//}
